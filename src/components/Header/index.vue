        ...
        ${
          this.$store.themeSettingsStore.skin === 'bordered'
            ? (this.$store.themeSettingsStore.navbarType === 'floating'
                ...
                : 'border-b border-gray-5002 dark:border-slate-700')
            : 'dark:border-b dark:border-slate-700 dark:border-opacity-60'
        }
        ${this.$store.themeSettingsStore.navbarColor}
        ${
          this.$store.themeSettingsStore.menuLayout === 'horizontal' && window.innerWidth > 1280
            ? 'py-1'
            : 'md:py-6 py-3'
        }
      `"
